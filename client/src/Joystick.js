...
var Joystick = new Phaser.Class({
  ...
  initialize: function Joystick(scene, settings) {
    ...
    this.singleDirection =
      settings.singleDirection === undefined ? true : settings.singleDirection;
    ...
    this.maxDistanceInPixels =
      settings.maxDistanceInPixels === undefined
        ? 200
        : settings.maxDistanceInPixels;
...
var VJoyPlugin = new Phaser.Class({
  ...
  initialize: function VJoyPlugin(scene, pluginManager) {
    ...
    pluginManager.registerGameObject(
      "joystick",
      this.joystickFactory,
      this.joystickCreator
    );
  },
